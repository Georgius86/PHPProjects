...
if ($_POST) {
	...
	$uvjet = $_GET["uvjet"];
} else if (isset($_SESSION["uvjetstrane"])) {
	$uvjet = $_SESSION["uvjetstrane"];
}
 ...
 ?>
		...
		<div class="row">
			<div class="large-12 columns">
				...
				<h2>Pregled strana/zemalja koje su učestvovale u ratu:</h2>
				...
				<div class="large-8 columns">
					<a href="dodaj.php?tko=strane" class="button tiny desno">Dodaj</a>
			...
			<div class="panel">
				<div id="rezultati" class="row">
					...
					$uvjetZaUpit="%" . $uvjet . "%";
					$izraz = $veza -> prepare("select sifra,naziv from strane where naziv like :uvjet limit " . (($stranica * 10)-10) . ",10");
