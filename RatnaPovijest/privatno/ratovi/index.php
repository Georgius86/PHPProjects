 ...
 ?>
		...
		<div class="row">
			<div class="large-12 columns">
				...
				<h2>Pregled srednjovjekovnih ratova:</h2>
				...
				<div class="large-8 columns">
					<a href="dodaj.php?tko=ratovi" class="button tiny desno">Dodaj</a>
			...
			<div class="panel">
				<div id="rezultati" class="row">
					...
					$uvjetZaUpit="%" . $uvjet . "%";
					$izraz = $veza -> prepare("select sifra,naziv,stoljece,gpocetak,gkraj from ratovi where naziv like :uvjet limit " . (($stranica * 10)-10) . ",10");
						...
						<div class="panel">
							<div class="row">
								...
								<div class="large-12 columns tablica">
				 					 ...
				 					 <?php echo $o -> naziv; ?> (<?php echo $o -> gpocetak; ?>. - <?php echo $o -> gkraj; ?>.)
