...
if($_POST){
		...
		$izraz  =$veza->prepare("delete from zemlje where sifra=:sifra");		
	print_r($_POST);
	$izraz->execute($_POST);
...
$izraz = $veza -> prepare('select a.sifra,a.naziv,b.ime,b.prezime
			from zemlje a inner join osobe b on a.vladar=b.sifra where a.sifra=:sifra');
		...
		<div class="row">
			<div class="large-12 columns">
				<form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
					<fieldset>
						<legend>
							Podaci o srednovjekovnim zemljama
						</legend>
